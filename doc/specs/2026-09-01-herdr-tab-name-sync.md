...
> **Superseded by:** [doc/specs/2026-09-16-herdr-tab-reorder-resilience.md](./2026-09-16-herdr-tab-reorder-resilience.md) - claim rule and per-session claim state in `### Write path and claim-once state machine`, `### Restore on shutdown`, `### Edge cases` only
